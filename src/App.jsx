...
const MESA_POS = {
  ...
  1:  { x: 95, y: 92 }, 2:  { x: 91, y: 82 }, 3:  { x: 95, y: 72 },
  4:  { x: 91, y: 62 }, 5:  { x: 95, y: 52 }, 6:  { x: 91, y: 42 },
  7:  { x: 95, y: 32 }, 8:  { x: 91, y: 22 },
  // Sector Pantallas (dos filas horizontales)
  9:  { x: 79, y: 19 }, 10: { x: 73, y: 19 }, 11: { x: 67, y: 22 },
  12: { x: 61, y: 19 }, 13: { x: 55, y: 22 }, 14: { x: 49, y: 19 },
  15: { x: 43, y: 22 }, 16: { x: 37, y: 19 }, 17: { x: 36, y: 25 },
  18: { x: 30, y: 19 }, 19: { x: 27, y: 25 }, 20: { x: 25, y: 19 },
  21: { x: 22, y: 25 }, 22: { x: 19, y: 19 },
  // Sector Escape
  23: { x: 31, y: 32 },
  24: { x: 31, y: 40 }, 25: { x: 25, y: 40 }, 26: { x: 18, y: 40 },
  27: { x: 31, y: 49 }, 28: { x: 25, y: 49 }, 29: { x: 18, y: 49 },
  30: { x: 31, y: 57 }, 31: { x: 25, y: 57 }, 32: { x: 18, y: 57 },
  33: { x: 25, y: 65 }, 34: { x: 18, y: 65 },
  35: { x: 25, y: 73 }, 36: { x: 25, y: 80 },
  // Sector DJ
  37: { x: 25, y: 88 }, 38: { x: 18, y: 84 }, 39: { x: 18, y: 92 },
  40: { x: 32, y: 73 },
  41: { x: 32, y: 80 }, 42: { x: 32, y: 88 }, 43: { x: 32, y: 96 },
  44: { x: 40, y: 80 }, 45: { x: 40, y: 88 }, 46: { x: 40, y: 96 },
  47: { x: 49, y: 80 }, 48: { x: 49, y: 88 }, 49: { x: 58, y: 80 },
  50: { x: 58, y: 88 }, 51: { x: 49, y: 96 },
  52: { x: 66, y: 84 }, 53: { x: 66, y: 92 }, 54: { x: 66, y: 99 },
  55: { x: 75, y: 80 }, 56: { x: 75, y: 88 }, 57: { x: 75, y: 96 },
  58: { x: 84, y: 84 },
};
