...
const MESA_POS = {
  ...
  1:  { x: 88, y: 92 }, 2:  { x: 85, y: 82 },
  3:  { x: 88, y: 72 }, 4:  { x: 85, y: 62 },
  5:  { x: 88, y: 52 }, 6:  { x: 85, y: 42 },
  7:  { x: 88, y: 32 }, 8:  { x: 85, y: 22 },
  // Sector Pantallas (fila superior)
  9:  { x: 76, y: 19 }, 10: { x: 70, y: 19 }, 11: { x: 65, y: 23 },
  12: { x: 60, y: 19 }, 13: { x: 55, y: 23 }, 14: { x: 50, y: 19 },
  15: { x: 45, y: 23 }, 16: { x: 40, y: 19 }, 17: { x: 36, y: 23 },
  18: { x: 31, y: 19 }, 19: { x: 25, y: 23 }, 20: { x: 27, y: 19 },
  21: { x: 22, y: 23 }, 22: { x: 18, y: 19 },
  // Sector Escape (bloque izquierdo)
  23: { x: 31, y: 32 },
  24: { x: 31, y: 40 }, 25: { x: 24, y: 40 }, 26: { x: 17, y: 40 },
  27: { x: 31, y: 49 }, 28: { x: 24, y: 49 }, 29: { x: 17, y: 49 },
  30: { x: 31, y: 57 }, 31: { x: 24, y: 57 }, 32: { x: 17, y: 57 },
  33: { x: 24, y: 65 }, 34: { x: 17, y: 65 },
  35: { x: 24, y: 73 }, 
  // Sector DJ
  36: { x: 24, y: 80 }, 37: { x: 24, y: 88 },
  38: { x: 17, y: 84 }, 39: { x: 17, y: 92 },
  40: { x: 31, y: 73 }, 41: { x: 31, y: 80 },
  42: { x: 31, y: 88 }, 43: { x: 31, y: 96 },
  44: { x: 39, y: 80 }, 45: { x: 39, y: 88 }, 46: { x: 39, y: 96 },
  47: { x: 47, y: 80 }, 48: { x: 47, y: 88 }, 49: { x: 55, y: 80 },
  50: { x: 55, y: 88 }, 51: { x: 47, y: 96 },
  52: { x: 64, y: 84 }, 53: { x: 64, y: 92 }, 54: { x: 64, y: 99 },
  55: { x: 73, y: 80 }, 56: { x: 73, y: 88 }, 57: { x: 73, y: 96 },
  58: { x: 82, y: 84 },
};
